...
const file_services_user_proto_user_proto_rawDesc = "" +
	"\n" +
	"\x1eservices/user/proto/user.proto\x12\x04user\x1a\x1fgoogle/protobuf/timestamp.proto\"\x96\x02\n" +
	"\x04User\x12\x0e\n" +
...
var file_services_user_proto_user_proto_msgTypes = make([]protoimpl.MessageInfo, 10)
